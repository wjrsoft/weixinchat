...
<style>
 ...
 <body>
	...
	<div class=""  style="margin-left:15px;margin-right: 15px;margin-top: 20px;">
  		<div class="weui-cells__title">市场价格</div>
  		<div class="weui-cell">
	    ...
	    <div class="weui-cells__title">您设置的买卖到价设置</div>
	   <div class="weui-cell">
  			<div class="weui-cell__hd">
  				<label class="weui-label">买多价：</label>
  			</div>
		    <div class="weui-cell__bd">
		      <input   id='setBuyPrice' class="weui-input"  type="text" value=${setBuyPrice} placeholder="价格涨破，消息推送" readonly>
		  	</div> 
	    </div>
	    
	      <div class="weui-cell">
  			<div class="weui-cell__hd">
  				<label class="weui-label">卖空价：</label>
  			</div>
		    <div class="weui-cell__bd">
		      <input   id='setSellPrice' class="weui-input"  type="text" value=${setSellPrice} placeholder="价格跌破，消息推送" readonly>
		  	</div> 
	    </div>
	    ...
	    <div class="weui-flex weui-list-btm">
			 <!--  <div class="weui-flex__item"><a href="javascript:checkSubmit();" class="weui-btn weui-btn_primary">确定</a></div> -->
			  <div class="weui-flex__item"><a href="javascript:WeixinJSBridge.call('closeWindow');" class="weui-btn weui-btn_plain-primary">返回</a></div>
		</div>
